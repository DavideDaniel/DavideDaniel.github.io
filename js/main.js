...
$(function() {
    "use strict"; // using use strict in local scope
...
// scroll listener for the D3 rendering
...
function fullscreenFix(){ // fix vertical when not overflow, call fullscreenFix() if .fullscreen content changes
  var h = $('body').height();
...
function parallaxPosition(e){ // set parallax background-position
